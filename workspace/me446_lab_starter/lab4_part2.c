...
void lab(float theta1motor,float theta2motor,float theta3motor,float *tau1,float *tau2,float *tau3, int error) {
    ...
    // Control Laws
    *tau1 = JT_11 * Fx + JT_12 * Fy + JT_13 * Fz + f_fric*u_fric1 +JT_13*Fzcmd/Kt;
    *tau2 = JT_21 * Fx + JT_22 * Fy + JT_23 * Fz + f_fric*u_fric2 +JT_23*Fzcmd/Kt;
    *tau3 = JT_31 * Fx + JT_32 * Fy + JT_33 * Fz + f_fric*u_fric3 +JT_33*Fzcmd/Kt;
